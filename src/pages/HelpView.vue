...
<template>
  <section class="space-y-6 p-6 bg-dark-blue min-h-screen text-lightest-blue">
    ...
    <div class="space-y-4">
      ...
      <div class="bg-medium-dark-blue p-6 rounded-lg border border-dark">
        <h2 class="text-xl font-bold mb-2">Who can see my capsules?</h2>
        <p class="text-lightest-blue/80">
          Public capsules can be viewed by other users of the platform. Private capsules are only visible to you
          and the configured recipient when the delivery date is reached.
        </p>
      </div>
      ...
      <div class="bg-medium-dark-blue p-6 rounded-lg border border-dark">
        <h2 class="text-xl font-bold mb-2">Contact Support</h2>
        <p class="text-lightest-blue/80">
          If you have problems with your account or with time capsules, you can contact our support team:
        </p>
        <p class="text-lightest-blue/80 mt-1">Email: support@timecapsulehub.com</p>
      </div>
    </div>
  </section>
</template>
